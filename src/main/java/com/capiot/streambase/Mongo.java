...
public class Mongo extends Operator implements Parameterizable {
    ...
    private void generateAndRespond(String ID, String Collection, Document data, Throwable err) {
    ...
    public Schema[] getProposedInputSchemas(String mainName){
        Schema sch = new Schema("MongoInput",new Schema.Field[]{
                ...
                Schema.createField(DataType.STRING,"Command"),
                Schema.createField(DataType.STRING, "Collection"),
                Schema.createField(DataType.STRING, "Filter"),
    ...
    public void processTuple(int inputPort, final Tuple tuple)
        ...
        if (cmd.equals("insert")) {
            ...
            mCore.insertData(tuple.getString("Collection"), tuple.getString("Data"),
                    (Document arg0, Throwable arg1) -> generateAndRespond(ID, Collection, arg0, arg1));
        } else if (cmd.equals("read")) {
            runTimeCheck(tuple, new String[]{"Collection", "Filter"});
            mCore.getData(tuple.getString("Collection"), tuple.getString("Filter"),
                    (arg0, arg1) -> generateAndRespond(ID, Collection, arg0, arg1));
            ...
            mCore.updateData(tuple.getString("Collection"), tuple.getString("Filter"), cmd.equals("upsert"),
                    ...
                    (final Document arg0, Throwable arg1) ->
                        generateAndRespond(ID, Collection, arg0, arg1));
            ...
            mCore.findOneAndUpdate(tuple.getString("Collection"), tuple.getString("Filter"), tuple.getString("Data"),
                    (result, t) -> generateAndRespond(ID, Collection, result, t));
            ...
            mCore.bulkinsert(tuple.getString("Collection")
                    ,tuple.getList("DataList")
                            .toArray(new String[tuple.getList("DataList").size()])
                    ,(result,t) -> generateAndRespond(ID,Collection,result,t));
        } else {
